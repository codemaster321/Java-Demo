...
public class HomeSignup extends javax.swing.JFrame {
    ...
    private void SignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignupActionPerformed
        ...
        try{
            ...
            {
                JOptionPane.showMessageDialog(null, "Set a username between 4 and 12 characters");
                return;
            }
            if(Password.length()< 8 || Password.length()>16 )
            {
                JOptionPane.showMessageDialog(null, "Set a password between 8-16 characters");
                return;
            }
